    ...
    "json_schema": {
        ...
        "schema": {
            ...
            "properties": {
                ...
                "course": {
                    "type": "string",
                    "description": "The course of the meal (e.g., breakfast, starter, entree, side, snacks, desserts, beverages)."
                },
                "category": {
                    "type": "string",
                ...
                "textures": {
                    "type": ["array", "null"],
                    "description": "Textures  explicitly mentioned or clearly inferred (e.g., soft, crispy, crunchy). If none, set to null.",
                    "items": {
                        "type": "string"
                    }
                },
                ...
                "preparation_time": {
                    "type": ["number", "null"],
                    "description": "Total time in minutes for dish preparation. If none, set to null."
                },
                "cooking_time": {
                    "type": ["number", "null"],
                    "description": "Total time in minutes for cooking the dish. If none, set to null."
                },
                "seasonality": {
                    "type": ["array", "null"],
            ...
            "required": [
                "dish_name", 
                "publication_date", "updated_date", "star_rating", "ratings_count","reviews_count", "times_shared",
                "course", "category", "country_of_origin",
                "ingredients", "alternative_ingredients", "primary_flavors", "secondary_flavors",
                "textures", "mouthfeel", "cooking_methods", "flavor_development_methods",
                "preparation_level", "preparation_time", "cooking_time",  
                "seasonality","dietary_labels", "brands",
                "sensory_analysis",
            ],
